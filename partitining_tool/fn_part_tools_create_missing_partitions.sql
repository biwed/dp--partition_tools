CREATE OR REPLACE FUNCTION partitining_tool.fn_part_tools_create_missing_partitions(
...
BEGIN
    ...
    OPEN
        ...
        LOOP
            ...
            EXIT WHEN NOT FOUND;
                PERFORM partitining_tool.fn_part_tools_create_operation(p_schema_name, p_table_name, p_granularity, var_row.partitionrangeend::timestamp, var_row.lead_start::timestamp);
