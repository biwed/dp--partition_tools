...
ALTER TABLE partitioning_tools_test.item_loc_soh_test  OWNER TO partitining_tool_owner;
...
SELECT partitining_tool.fn_part_tools_create_partitions(
	p_table_name := 'item_loc_soh_test', 
	p_schema_name:= 'partitioning_tools_test', 
...
SELECT partitining_tool.fn_part_tools_merge_partitions(
	p_table_name := 'item_loc_soh_test', 
	p_schema_name:= 'partitioning_tools_test', 
	p_granularity := '3 month'::interval, 
...
SELECT partitining_tool.fn_part_tools_move_partitions(
	p_table_name := 'item_loc_soh_test', 
	p_schema_name:= 'partitioning_tools_test', 
	p_limit_operations := 2, 
...
SELECT partitining_tool.fn_part_tools_unload_to_s3_partitions(
	p_table_name := 'item_loc_soh_test', 
	p_schema_name:= 'partitioning_tools_test', 
	p_lower_bound := '5 year'::interval, 
...
select *
from partitining_tool.fn_part_tools_get_part_table_spase('partitioning_tools_test', 'item_loc_soh_test')
...
select partitining_tool.fn_part_tools_delete_partitions(
