...
- Поле учавстрвует постоянно в выборке.
...
- merge_partitions - объединение партиций с выравниванием таблицы и партиций. Порядок выполнения 2.
